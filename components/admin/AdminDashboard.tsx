    ...
    <article className="group relative overflow-hidden rounded-[24px] border border-border/70 bg-card/95 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.05)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_40px_rgba(0,0,0,0.09)]">
      ...
      <div className="relative flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-3 text-2xl font-semibold tracking-tight text-foreground md:text-[30px]">
            {value}
          </p>
          <div className="mt-3">
            {typeof trend === "number" ? (
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.55fr_0.95fr]">
        <SectionShell
          ...
          subtitle="Executive trend monitoring across revenue, orders, refunds, payments, and commercial momentum."
          action={
        ...
        <SectionShell
          ...
          subtitle="Immediate execution signals from fulfillment, customer intent, and risk pressure."
        >
          <div className="space-y-4">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <SectionShell
          ...
          subtitle="Variant-aware stock operations across product catalog, warehouses, and reservations."
        >
          <div className="space-y-5">
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-[22px] border border-border/60 bg-muted/20 p-4">
        ...
        <SectionShell
          ...
          subtitle="Order pipeline, payment posture, shipment readiness, and refund pressure."
          action={
            <Link
              href="/admin/orders"
      ...
      <div className="grid gap-6 xl:grid-cols-[1.05fr_1.05fr_0.9fr]">
        <SectionShell
          ...
          subtitle="Customer acquisition quality, buying behavior, carts, reviews, and loyalty signals."
        >
          <div className="space-y-5">
            <div className="grid gap-3 sm:grid-cols-2">
              {[
        ...
        <SectionShell
          title="Marketing, Content & Storefront Control"
          subtitle="Campaign health, content readiness, traffic quality, sessions, and discovery signals."
        >
          <div className="space-y-5">
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-[22px] border border-border/60 bg-muted/20 p-4">
        ...
        <SectionShell
          title="Support, Activity & System Monitoring"
          subtitle="Chat workload, recent platform actions, and operational watchpoints."
        >
          <div className="space-y-5">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_1fr]">
        <SectionShell
          title="Top Products & Variant Momentum"
          subtitle="Best-selling catalog leaders mapped to product performance and inferred variant momentum."
          action={
            <Link
              href="/admin/products"
              className="inline-flex items-center gap-1 text-sm text-muted-foreground transition hover:text-foreground"
        ...
        <SectionShell
          title="Inventory Movement & Merchandising Signals"
          subtitle="Recent stock activity, wishlist pressure, and catalog demand indicators."
        >
          <div className="space-y-5">
            <div className="rounded-[24px] border border-border/60 bg-muted/15 p-4">
              <div className="mb-3 flex items-center gap-2">
